...
export default function TodoUpdateForm(props) {
  ...
  const [myField, setMyField] = React.useState(initialValues.myField);
  ...
  const resetStateValues = () => {
    ...
    setMyField(
      typeof cleanValues.myField === "string"
        ? cleanValues.myField
        : JSON.stringify(cleanValues.myField)
    );
    setErrors({});
  };
      ...
      <TextAreaField
        ...
        onChange={(e) => {
          ...
          if (onChange) {
            ...
            const result = onChange(modelFields);
            value = result?.myField ?? value;
          }
          if (errors.myField?.hasError) {
            runValidationTasks("myField", value);
          }
          setMyField(value);
        }}
        onBlur={() => runValidationTasks("myField", myField)}
        errorMessage={errors.myField?.errorMessage}
        hasError={errors.myField?.hasError}
        {...getOverrideProps(overrides, "myField")}
      ></TextAreaField>
      <Flex
